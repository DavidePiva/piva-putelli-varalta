...
public class Attivita implements Serializable {
	...
	//bi-directional many-to-one association to Pacchetto_Attivita
	@OneToMany(mappedBy="attivita")
	private List<Pacchetto_Attivita> pacchettoAttivitas;
	...
	public List<Pacchetto_Attivita> getPacchettoAttivitas() {
		return this.pacchettoAttivitas;
	}

	public void setPacchettoAttivitas(List<Pacchetto_Attivita> pacchettoAttivitas) {
		this.pacchettoAttivitas = pacchettoAttivitas;
	}

	public Pacchetto_Attivita addPacchettoAttivita(Pacchetto_Attivita pacchettoAttivita) {
		getPacchettoAttivitas().add(pacchettoAttivita);
		pacchettoAttivita.setAttivita(this);

		return pacchettoAttivita;
	}

	public Pacchetto_Attivita removePacchettoAttivita(Pacchetto_Attivita pacchettoAttivita) {
		getPacchettoAttivitas().remove(pacchettoAttivita);
		pacchettoAttivita.setAttivita(null);
